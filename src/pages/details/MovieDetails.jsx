...
export default function MovieDetails() {
  ...
  let movie = getItem(parseInt(params.movieId));

  let Arrays = getItems();
  let extremes = Arrays.filter((Array) => Array.id > 1030 && Array.id < 1039);
  return (
    <div>
      {movie && (
        <>
          <OsBanner style={{ backgroundImage: `url(${movie.background})` }} />
          <OsContainer className="mb-3 movie-content">
            ...
            <div className="movie-content__info">
              ...
              <div className="genres">
                <span className="genres__item">{movie.category}</span>
                <span className="genres__item">{movie.language}</span>
              </div>
              <p className="overview">{movie.information}</p>
              {/* VIDEO PLAYER */}
              <div>
                <OsIframe
                  src={movie.trailer}
                  ...
                  <div className="container_ep_content">
                    ...
                    <div id="mas" className="container_ep_content_link_src">
                      ...
                      <div
                        ...
                        onClick={clickVideo}
                      >
                        <a href={movie.trailer} frameBorder="0"></a>
                      ...
                      {movie.episodes.map((episode) => (
                        ...
                        >
                          ...
                          <p className="no-selection">Ver Ahora</p>
                        </div>
                      ))}
                    </div>
                  </div>
